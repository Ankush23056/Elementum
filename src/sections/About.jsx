...
export default function About() {
  const { description } = SITE_CONTENT.about;
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between mb-24 lg:mb-40 gap-12 lg:gap-20 overflow-hidden md:overflow-visible">
          ...
          <motion.div 
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-[4.2rem] font-sans text-[#111827] leading-[1.1] mb-6 tracking-tight">
            ...
            <motion.a 
              ...
              <span className="ml-4 w-16 h-[1px] bg-gray-400 group-hover:bg-brand-red transition-colors relative">
                <span className="absolute right-0 top-1/2 -translate-y-1/2 w-2 h-2 border-r border-t border-gray-400 group-hover:border-brand-red rotate-45 transform"></span>
              </span>
            </motion.a>
          </motion.div>
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20 overflow-hidden md:overflow-visible">
          ...
          <motion.div 
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-[4.2rem] font-sans text-[#111827] leading-[1.1] mb-6 mt-10 lg:mt-0 tracking-tight">
