  ...
  return (
    <section className="relative bg-white pt-24 md:pt-32 pb-10 overflow-hidden flex flex-col items-center">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 text-center mt-4">
        ...
        {/* Headline */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[7.5rem] font-sans font-medium text-[#111827] leading-[1.05] tracking-tight mb-8">
          The{' '}
        ...
        {/* Sub-paragraph */}
        <p className="text-[#4b5563] text-sm sm:text-base md:text-lg max-w-3xl mx-auto mt-14 mb-8 leading-relaxed font-light">
      ...
      <div className="relative w-full max-w-[1400px] mx-auto h-[200px] sm:h-[450px] lg:h-[400px] mt-8 sm:mt-16 z-10 overflow-hidden md:overflow-visible">
        ...
        <div className="absolute left-[2%] md:left-[5%] bottom-[5%] w-24 h-24 sm:w-36 sm:h-36 lg:w-48 lg:h-48 rounded-full overflow-hidden border-[4px] md:border-[6px] border-white shadow-xl z-20">
        ...
        <div className="absolute left-[15%] md:left-[20%] bottom-[15%] lg:bottom-[20%] w-20 h-20 sm:w-32 sm:h-32 lg:w-44 lg:h-44 rounded-full overflow-hidden border-[4px] md:border-[6px] border-white shadow-lg z-10">
        ...
        <div className="absolute left-[30%] top-[0%] lg:top-[10%] w-28 h-28 sm:w-44 sm:h-44 lg:w-56 lg:h-56 rounded-full overflow-hidden border-[4px] md:border-[6px] border-white shadow-xl z-20">
        ...
        <div className="absolute left-[40%] lg:left-[45%] bottom-[0%] w-24 h-24 sm:w-40 sm:h-40 lg:w-48 lg:h-48 rounded-full overflow-hidden border-[4px] md:border-[6px] border-white shadow-xl z-20">
        ...
        <div className="absolute right-[30%] lg:right-[35%] top-[10%] lg:top-[15%] w-20 h-20 sm:w-36 sm:h-36 lg:w-44 lg:h-44 rounded-full overflow-hidden border-[4px] md:border-[6px] border-white shadow-md z-10">
        ...
        <div className="absolute right-[20%] lg:right-[25%] bottom-[15%] w-24 h-24 sm:w-40 sm:h-40 lg:w-[13rem] lg:h-[13rem] rounded-full overflow-hidden border-[4px] md:border-[6px] border-white shadow-xl z-20">
        ...
        <div className="absolute right-[5%] lg:right-[10%] top-[-10%] lg:top-[5%] w-28 h-28 sm:w-44 sm:h-44 lg:w-56 lg:h-56 rounded-full overflow-hidden border-[4px] md:border-[6px] border-white shadow-xl z-20">
        ...
        <div className="absolute right-[-5%] lg:right-[2%] bottom-[0%] lg:bottom-[5%] w-24 h-24 sm:w-36 sm:h-36 lg:w-44 lg:h-44 rounded-full overflow-hidden border-[4px] md:border-[6px] border-white shadow-xl z-20">
